...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for any expressions, set as null for now
    First_Operand: null,
    //this checks whether or not the 2nd operand has been input by the user
    Wait_Second_Operand: false,
    //this will hold the operator, set as null for now
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    //this checks the Wait_Second_Operand is true and sets Display_Value
    //to the key that was clicked on.
    if (Wait_Second_Operand === true) {
        Calculator.Display_Value = digit;
        Calculator.Wait_Second_Operand = false;
    } else {
        //this overwrited Display_Value if current value is 0
...
function Input_Decimal(dot) {
    //this ensures that accidental clicking of decimal points doesnt cause a bug
...
keys.addEventListener('click', (event) => {
    ...
    //ensures AC clears all inputs from calculator screen
